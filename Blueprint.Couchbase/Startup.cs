...
namespace Blueprint.Couchbase
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var cbSettings = appSettings.CouchBase;
            services.AddSingleton<ICache>(s => new CouchbaseCache(cbSettings.Uris, cbSettings.UserName, cbSettings.Password, cbSettings.Bucket));
            services.AddLogging(
               builder =>
               {
